...
export SAVE_CHECKPOINT_DIR=/path/to/save/verl_ckpts

# export VLLM_ATTENTION_BACKEND=XFORMERS # vllm + qwen2-7b with flash_attn has some issues

BASEDIR=/path/to/DeepEyes-Datasets-47k
...
# RS_DATASET=${HOME}/sci/anrongqiao/DeepEyes/scripts/geollava8k_size12k_all_threads.parquet
RS_DATASET=/path/to/geollava8k_size12k_all_threads_resized.parquet


EXPERIMENT_NAME="debug_text_en_cot__geollava_superrs"
REF_MODEL_PATH=~/saves/Qwen2.5-VL-7B-Instruct/text_en_cot__geollava_superrs
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    +debug=False \
    +vs_debug=False \
    data.train_files=[${VISUAL_DATASET_TRAIN_0_1_2},${VISUAL_DATASET_TRAIN_0_8},${EUREKA_DATASET_TRAIN},${RS_DATASET}] \
    data.val_files=[${RS_DATASET}] \
    ...
    actor_rollout_ref.rollout.max_num_batched_tokens=20834 \
    ...
    actor_rollout_ref.rollout.agent.single_response_max_tokens=18198 \
